...
function GridCard({ article }: GridCardProps) {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-sm font-bold leading-snug text-gray-900 dark:text-gray-100 line-clamp-2 mb-1.5 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
        {article.title}
      </h3>
