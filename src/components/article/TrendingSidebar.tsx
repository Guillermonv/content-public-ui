  ...
  return (
    <div className="space-y-5 sticky top-20">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden shadow-sm">
        <div className="flex items-center gap-2 px-5 py-4 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-orange-50 to-transparent dark:from-orange-950/20">
          <Flame size={17} className="text-orange-500 fill-orange-400" />
          <h3 className="font-bold text-gray-900 dark:text-gray-100 text-sm">Trending ahora</h3>
        </div>
            ...
            {CATEGORIES.filter((c) => c.id !== 'all').map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide transition-all duration-150 ${
                    isActive
      ...
      {/* Newsletter CTA */}
      <div className="bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl p-5 text-white shadow-sm">
        ...
        <button className="w-full bg-white text-primary-700 font-bold text-sm py-2.5 rounded-xl hover:bg-primary-50 transition-colors">
          Suscribirme gratis
        </button>
      </div>
    </div>
